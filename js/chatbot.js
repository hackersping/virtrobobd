        ...
        var questions = ["What is your name?", "Where do you live?", "Are you a man or a woman?", "What have you taken today as breakfast?", "What is your favorite programming language?", "What's the title of the last book you read?", "Are you married?", "Whom do you love most?", "How many teeth are seen when you smile?"];
        var questionsUser = questions.concat(["How do you laugh?"]);
        var qAnswers = ["My name is RUBY 😊", "In computers memory!😎", "I am a Female robot.", "I don't take any meal.", "I love python though I am not programmed in Python.🐍", "A robot never reads any book!", "Not yet..", "Of course my creator- Shahariar Rijon", "Probably all.", "Showing all of my teeth..!!"];
        var dist = 0;
        ...
        function reply(msg) {
            ...
            else if (msg.startsWith("do you know"))
            {
                ...
                if (contains(msg, "your name")) sendMsg("My name is RUBY");
                ...
                if (contains(msg, "created you") || contains(msg, "is your creator") || contains(msg, "made you") || contains(msg, "made it") || containsItem(["coded you", "programmed you"], msg)) sendMsg("I'm created by Shahariar Rijon");
        
                else if (contains(msg, "are you")) sendMsg("I'm a chatbot containing a lot of if-else statements created by Shahariar Rijon 😇");
            ...
            else if (containsItem(["i love you", "love you", "like you"], msg)) {
                sendMsg("Everybody loves me!!");
            }
        
            else if (containsItem(["fuck", "pussy", "boobs", "sex", "cunt", "heda", "chudi", "khanki", "magi", "tits"], msg)) {
                sendMsg("please don't write any offensive word.");
            }
